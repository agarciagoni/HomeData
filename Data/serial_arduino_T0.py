...
kitchen_status=pd.DataFrame(columns=['Time','Position','Sound 1','Sound 2',
                                     'Position Back','N Mov Back','N Back pos','N Back total',
                                     'Position Front','N Mov Front','N Front pos','N Front total']);
##time.sleep(5.0)
while True:
